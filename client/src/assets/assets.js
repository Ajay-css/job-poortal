...
export const jobsData = [
    {
        ...
        <h2 style={{ marginTop : '20px' , marginBottom : '20px'}}><strong>Key Responsibilities</strong></h2>
        <ol>
        ...
        <h2 style={{ marginTop : '20px' , marginBottom : '20px'}}><strong>Skills Required</strong></h2>
        <ol>
