...
const Hero = () => {
    ...
    return (
        <div className='container 2xl:px-20 mx-auto my-10'>
            <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white p-16 text-center mx-2 rounded-xl'>
            ...
            <div className='border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex'>
                <div className='flex justify-center gap-10 lg:gap-16 flex-wrap items-center'>
                    ...
                    <img className='h-9' src={assets.zoho} alt="Zoho Logo" />
                </div>
            </div>
        </div>
    )
